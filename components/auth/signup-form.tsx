  ...
  return (
    <div className="px-2">
      <div className="text-center mb-8">
        ...
        <h1 className="heading-display text-2xl tracking-tight mt-4">회원가입</h1>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="h-11 bg-background border-border/60 focus:border-union focus:ring-union/20 transition-colors tracking-widest text-center"
                  value={verifyCode}
          ...
          <Button
            type="submit"
            className="w-full h-11 bg-union text-white hover:bg-union/90 transition-colors mt-2"
