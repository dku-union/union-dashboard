  ...
  return (
    <div className="bg-[#EDF2FA] text-[#262725] overflow-x-clip">
      ...
      <main>
        ...
        <StickySection zIndex={3}><LandingMarquee /></StickySection>
        <StickySection zIndex={4}><LandingFeatureBento /></StickySection>
        <StickySection zIndex={5}><LandingMiniAppCatalog /></StickySection>
        <StickySection zIndex={6}><LandingHowItWorks /></StickySection>
        <StickySection zIndex={7}><LandingUseCases /></StickySection>
        <StickySection zIndex={8}><LandingFaqCta /></StickySection>
      </main>
    </div>
  );
}
