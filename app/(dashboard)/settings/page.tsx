  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="animate-fade-up">
        <h1 className="text-heading-1">설정</h1>
        <p className="text-body-sm text-muted-foreground mt-1">계정 및 프로필 설정을 관리하세요.</p>
      </div>

      <Card className="animate-fade-up delay-1 border-border/60">
        <CardHeader>
          <CardTitle className="text-label uppercase tracking-wider text-muted-foreground">프로필 정보</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-label uppercase tracking-wider text-muted-foreground">이름</Label>
            <Input id="name" defaultValue={user?.name} className="h-11 bg-muted/30 border-border/60 focus:border-union" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="email" className="text-label uppercase tracking-wider text-muted-foreground">이메일</Label>
      ...
      <Card className="animate-fade-up delay-2 border-border/60">
        <CardHeader>
          <CardTitle className="text-label uppercase tracking-wider text-muted-foreground">비밀번호 변경</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="currentPassword" className="text-label uppercase tracking-wider text-muted-foreground">현재 비밀번호</Label>
            <Input id="currentPassword" type="password" className="h-11 bg-muted/30 border-border/60 focus:border-union" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="newPassword" className="text-label uppercase tracking-wider text-muted-foreground">새 비밀번호</Label>
            <Input id="newPassword" type="password" className="h-11 bg-muted/30 border-border/60 focus:border-union" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="confirmNewPassword" className="text-label uppercase tracking-wider text-muted-foreground">새 비밀번호 확인</Label>
